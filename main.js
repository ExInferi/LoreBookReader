...
/* harmony export */   fontheavy: () => (/* binding */ fontheavy),
/* harmony export */   sourceimg: () => (/* binding */ sourceimg)
/* harmony export */ });
...
/* harmony import */ var _lorebook__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lorebook */ "./lorebook.ts");
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_lorebook__WEBPACK_IMPORTED_MODULE_0__]);
_lorebook__WEBPACK_IMPORTED_MODULE_0__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
const loreReader = new _lorebook__WEBPACK_IMPORTED_MODULE_0__["default"]();
/**
...
function readLore() {
    let book;
    let image = alt1__WEBPACK_IMPORTED_MODULE_4__.captureHoldFullRs();
...
function writeLore(book) {
    ...
    const text = lines.replace(/(<br\s*\/?>\s*){3,}/g, '<br> <br>\n');
    // Format pagenumbers
...
const captureLore = document.querySelector('#captureLore');
captureLore.onclick = readLore;
// Setup Alt1 hotkey for triggering the reading
alt1__WEBPACK_IMPORTED_MODULE_4__.on('alt1pressed', readLore);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ LoreBookReader)
/* harmony export */ });
...
/* harmony import */ var _assets__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./assets */ "./assets/index.ts");
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_assets__WEBPACK_IMPORTED_MODULE_0__]);
_assets__WEBPACK_IMPORTED_MODULE_0__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
class LoreBookReader {
    pos = null;
    bookimg = _assets__WEBPACK_IMPORTED_MODULE_0__.sourceimg;
    /**
    ...
    find(img) {
        ...
        if (!img) {
            img = alt1_base__WEBPACK_IMPORTED_MODULE_1__.captureHoldFullRs();
        }
        ...
        if (pos.length > 1) {
            console.warn('More than one possible lore book found');
        }
    ...
    readLines(imageBuffer, x, y) {
        ...
        const line = alt1_ocr__WEBPACK_IMPORTED_MODULE_2__.readLine(imageBuffer, _assets__WEBPACK_IMPORTED_MODULE_0__.font, detectedColor, x, y, true, false);
    ...
    read() {
        ...
        const imageBuffer = alt1_base__WEBPACK_IMPORTED_MODULE_1__.capture(this.pos);
        ...
        const comparison = alt1_base__WEBPACK_IMPORTED_MODULE_1__.simpleCompare(imageBuffer, _assets__WEBPACK_IMPORTED_MODULE_0__.sourceimg, OFFSET_X, OFFSET_Y);
        if (comparison !== 0) {
        ...
        textData.titleHash = imageBuffer.getPixelHash(new alt1_base__WEBPACK_IMPORTED_MODULE_1__.Rect(110, 8, 200, 8));
        ...
        const leftPage = alt1_ocr__WEBPACK_IMPORTED_MODULE_2__.readLine(imageBuffer, _assets__WEBPACK_IMPORTED_MODULE_0__.font, [0, 0, 0], PAGE_LEFT, PAGE_NUM_POS, true, false);
        const rightPage = alt1_ocr__WEBPACK_IMPORTED_MODULE_2__.readLine(imageBuffer, _assets__WEBPACK_IMPORTED_MODULE_0__.font, [0, 0, 0], PAGE_RIGHT, PAGE_NUM_POS, false, true);
